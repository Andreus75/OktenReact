...
const getDetailsMovie = async () => await instance.get('/movie/{movie_id}');
...
export {discoverMovie, discoverGenre, getDetailsMovie, getPopularMovie, getTopMovies, getLatestMovie, getImagesMovie};